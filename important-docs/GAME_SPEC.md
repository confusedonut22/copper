...
| Prototype | Archived React JSX reference implementation |
...
- Dealer **hits soft 17**
- Blackjack pays **7:5** on a natural two-card 21
- Double down permitted on hard 9, 10, or 11 only
...
| Blackjack | 7:5 | Natural 21 on first 2 cards |
...
|----------|----------------|
| Blackjack (base game) | ~97.9%* |
| Perfect Pairs | 86.4952% |
| 21+3 | 85.7029% |

*Base-game RTP estimate with H17 rules, no DAS, no resplit, hard 9/10/11 doubling, and 7:5 blackjack payout. Verified across multi-million-round simulation runs at ~97.9%, safely below the 98.0% ceiling required by Stake Engine.
...
- Starting balance: 1,000,000,000 ($1000.00)
...
- Frontend: Maintain the shipped Svelte + Vite runtime used by the live submission build
